...
`)
    ...
    document.getElementById(id).addEventListener("click", () => {
      if(options.popup === true) {
        var win = popupCenter({url: `https://smartlist.ga/dashboard/login.php?auth=true&appId=${options.appId}&close`, title: 'xtf', w: window.innerWidth/2.5, h: window.innerHeight/2})
